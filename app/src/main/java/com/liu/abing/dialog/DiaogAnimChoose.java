        ...
        dialog.setOnOperItemClickL(new OnOperItemClickL() {
            ...
            public void onOperItemClick(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    ((LiuDialogActivity) context).setBasIn((BaseAnimatorSet) cs[position].newInstance());
                   ToastUtil.showShort(context, animType + "设置成功");
                    dialog.dismiss();
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public static void dissmissAnim(final Context context) {
        ...
        dialog.setOnOperItemClickL(new OnOperItemClickL() {
            ...
            public void onOperItemClick(AdapterView<?> parent, View view, int position, long id) {
                try {
                    String animType = contents[position];
                    ((LiuDialogActivity) context).setBasOut((BaseAnimatorSet) cs[position].newInstance());
                    ToastUtil.showShort(context, animType + "设置成功");
                    dialog.dismiss();
                } catch (Exception e) {
                    e.printStackTrace();

...
import com.liu.abing.dialog.extra.CustomBaseDialog;
import com.liu.abing.dialog.extra.IOSTaoBaoDialog;
import com.liu.abing.dialog.extra.ShareBottomDialog;
import com.liu.abing.dialog.extra.ShareTopDialog;
import com.liu.extend.adapters.HomeAdapter;
import com.liu.extend.adapters.TestAdapter;
 ...
 * 修改备注：
 */
public class LiuDialogActivity extends BaseActivity implements ExpandableListView.OnChildClickListener {
    @BindView(R.id.elv)
        ...
        dialog.setOnBtnClickL(
                new OnBtnClickL() {
                    ...
                    public void onBtnClick() {
                        ToastUtil.showShort(mContext, "left");
                        dialog.dismiss();
                    }
                },
                new OnBtnClickL() {
                    @Override
                    public void onBtnClick() {
                        ToastUtil.showShort(mContext, "right");
                        dialog.dismiss();
                    }
                });
    }
    ...
    private void NormalDialogOneBtn() {
        ...
        dialog.setOnBtnClickL(new OnBtnClickL() {
            @Override
            public void onBtnClick() {
                ToastUtil.showShort(mContext, "middle");
                dialog.dismiss();
            }
        });
    }
    ...
    private void NormalListDialog() {
        ...
        dialog.setOnOperItemClickL(new OnOperItemClickL() {
            ...
            public void onOperItemClick(AdapterView<?> parent, View view, int position, long id) {
                ToastUtil.showShort(mContext, mMenuItems.get(position).mOperName);
                dialog.dismiss();
            }
        });
    }
    ...
    private void ActionSheetDialog() {
        ...
        dialog.setOnOperItemClickL(new OnOperItemClickL() {
            @Override
            public void onOperItemClick(AdapterView<?> parent, View view, int position, long id) {
                ToastUtil.showShort(mContext, stringItems[position]);
                dialog.dismiss();
            }
        });
    }

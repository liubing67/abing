...
public class MultiFeedAdapter extends RecyclerView.Adapter {
  ...
  public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
    if (holder instanceof TimeHolder) {
      ...
      new ImageManager(holder.itemView.getContext()).loadResImage(getAvatarResId(position),((FeedAdapter.FeedHolder) holder).mIvAvatar);
      new ImageManager(holder.itemView.getContext()).loadResImage(getContentResId(position),((FeedAdapter.FeedHolder) holder).mIvContent);

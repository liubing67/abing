...
import com.liu.extend.adapters.ExpandableListAdapter;
import com.liu.extend.entity.GoodBean;
import com.liu.extend.interfaces.UpdateView;
import com.tools.views.SmoothCheckBox;
 ...
 * 类描述：
 * 创建人：liubing
 * 创建时间：2016/12/22 10:29
 * 修改人：Administrator
 * 修改时间：2016/12/22 10:29
 * 修改备注：
 */
public class ShopCarActivity extends BaseActivity implements UpdateView, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shopcaractivity);
        initView();
        initData();
        initEvent();
    }

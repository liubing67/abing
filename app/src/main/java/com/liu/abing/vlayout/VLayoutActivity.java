...
import com.liu.extend.adapters.VLayoutAdapter;
import com.liu.extend.interfaces.VLayoutItemClickListener;
 ...
 * 类描述：
 * 创建人：liubing
 * 创建时间：2018-2-26 11:16
 * 修改人：Administrator
 * 修改时间：2018-2-26 11:16
 * 修改备注：
 */
public class VLayoutActivity extends BaseActivity implements VLayoutItemClickListener {

    RecyclerView recyclerView;
    VLayoutAdapter Adapter_linearLayout,Adapter_GridLayout,Adapter_FixLayout,Adapter_ScrollFixLayout
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Adapter_linearLayout  = new VLayoutAdapter(this, linearLayoutHelper, 4, listItem) {
        ...
        Adapter_StickyLayout = new VLayoutAdapter(this, stickyLayoutHelper,1, listItem) {
            // 设置需要展示的数据总数,此处设置是1
...
//        }
        ...
        Adapter_ScrollFixLayout  = new VLayoutAdapter(this, scrollFixLayoutHelper,1, listItem) {
            // 设置需要展示的数据总数,此处设置是1
        ...
        Adapter_GridLayout  = new VLayoutAdapter(this, gridLayoutHelper,36, listItem) {
        ...
        FixLayoutHelper fixLayoutHelper = new FixLayoutHelper(FixLayoutHelper.BOTTOM_LEFT,40,100);
        // 参数说明:
        // 参数1:设置吸边时的基准位置(alignType) - 有四个取值:TOP_LEFT(默认), TOP_RIGHT, BOTTOM_LEFT, BOTTOM_RIGHT
        // 参数2:基准位置的偏移量x
        // 参数3:基准位置的偏移量y
...
//        }
        ...
        Adapter_FixLayout  = new VLayoutAdapter(this, fixLayoutHelper,1, listItem) {
            // 设置需要展示的数据总数,此处设置是1
...
//        }
        ...
        floatLayoutHelper.setDefaultLocation(getWindowManager().getDefaultDisplay().getWidth()-50, getWindowManager().getDefaultDisplay().getHeight()-50);// 设置布局里Item的初始位置
        Adapter_FloatLayout = new VLayoutAdapter(this, floatLayoutHelper,1, listItem) {
            // 设置需要展示的数据总数,此处设置是1
        ...
        Adapter_ColumnLayout = new VLayoutAdapter(this, columnLayoutHelper,3, listItem) {
            // 设置需要展示的数据总数,此处设置是3
        ...
        Adapter_onePlusNLayout = new VLayoutAdapter(this, onePlusNLayoutHelper,5, listItem) {
        ...
        Adapter_StaggeredGridLayout = new VLayoutAdapter(this, staggeredGridLayoutHelper,20, listItem) {
            // 设置需要展示的数据总数,此处设置是20

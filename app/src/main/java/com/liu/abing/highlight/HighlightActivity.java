package com.liu.abing.highlight;
...
//                .addHighLight(R.id.btn_bottomLight,R.layout.info_gravity_left_down,new OnTopPosCallback(),new CircleLightShape())
                .addHighLight(view,R.layout.info_gravity_left_down,new OnBottomPosCallback(160),new CircleLightShape());
        mHightLight.show();
    }

package com.liu.abing.drawphotoview;
...
import com.tools.views.drawphoto.DragPhotoView;
...
public class DragPhotoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < mPhotoViews.length; i++) {
            mPhotoViews[i] = (DragPhotoView) View.inflate(this, R.layout.draw_item_viewpager, null);
            mPhotoViews[i].setImageResource(R.mipmap.erha);

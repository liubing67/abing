...
public class VLayoutAdapter extends DelegateAdapter.Adapter<VLayoutAdapter.MainViewHolder> {
    ...
    private VLayoutItemClickListener myItemClickListener;
    // 用于设置Item点击事件
    ...
    public MainViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MainViewHolder(LayoutInflater.from(context).inflate(R.layout.vlayout_item, parent, false));
    }
    ...
    public void setOnItemClickListener(VLayoutItemClickListener listener) {

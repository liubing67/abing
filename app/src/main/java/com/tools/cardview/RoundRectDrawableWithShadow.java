...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    * */
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList backgroundColor, float radius,
        ...
        mShadowStartColor = resources.getColor(com.liu.abing.R.color.cardview_shadow_start_color);
        mShadowEndColor = resources.getColor(com.liu.abing.R.color.cardview_shadow_end_color);
        mInsetShadow = resources.getDimensionPixelSize(com.liu.abing.R.dimen.cardview_compat_inset_shadow);
    ...
    void setShadowSize(float shadowSize, float maxShadowSize) {
        ...
        Log.i("RoundRect", "shadowSize:" + mShadowSize + " maxShadowSize:" + mMaxShadowSize);
        mDirty = true;
        invalidateSelf();
    }
...
//        canvas.translate(0, -mRawShadowSize / 2);
    ...
    public void getOutline( Outline outline) {
        outline.setRoundRect((int) mCardBounds.left, (int) mCardBounds.top,
                (int) mCardBounds.right,(int) mCardBounds.bottom,mCornerRadius);
    }
}

 ...
 * 类描述：
 * 创建人：liubing
 * 创建时间：2018-1-10 10:00
 * 修改人：Administrator
 * 修改时间：2018-1-10 10:00
 * 修改备注：
 */
public class StorageUtils {
    ...
    public static File getCacheDirectory(Context context,String fileName) {
        return getCacheDirectory(context, true,fileName);
    }
     ...
     * {@link Context#getCacheDir() Context.getCacheDir()} returns null).
     */
    public static File getCacheDirectory(Context context, boolean preferExternal,String fileName) {
     ...
     */
    public static File getIndividualCacheDirectory(Context context,String fileName) {
        return getIndividualCacheDirectory(context, INDIVIDUAL_DIR_NAME,fileName);
    }
    ...
    public static File getIndividualCacheDirectory(Context context, String cacheDir,String fileName) {
        File appCacheDir = getCacheDirectory(context,fileName);
